...
class lemlit_role_create
{
...

    {
        ...
        $peneliti->remove_cap('publish_posts');
    }
    function create_role_reviewer()
    {
        ...
        $reviewer->add_cap('edit_others_proposals');
        $reviewer->remove_cap('publish_proposals');
        $reviewer->remove_cap('publish_posts');
    }
    function create_role_drf()
    {
        ...
        $drf = get_role('drf');
        $drf->add_cap('edit_others_proposals');
    }
